    ...
    <div class="card border">
        <div class="card-body">
            <form action="{{ route('admin.homepage-banner-section-two') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_one->banner_two->banner_image) }}" alt=""
                        width="150px">
                </div>
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="banner_two_old_image"
                        value="{{ @$homepage_section_banner_one->banner_two->banner_image }}">
                </div>
                <div class="form-group">
                    <label>Banner url</label>
                    <input type="text" class="form-control" name="banner_two_url"
                        value="{{ @$homepage_section_banner_one->banner_two->banner_url }}">
                </div>
