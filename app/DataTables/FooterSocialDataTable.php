...
class FooterSocialDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $deleteBtn = '
                    <form action="' . route('admin.footer-social.destroy', $query->id) . '" method="POST" style="display:inline;">
     ...
     *
     * @return QueryBuilder<FooterSocial>
     */
    ...
    {
        return $this->builder()
            ->setTableId('footersocialdattable-table')
