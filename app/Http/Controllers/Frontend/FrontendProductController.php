...
class FrontendProductController extends Controller
{
    ...
    public function productsIndex(Request $request)
    {
        ...
        return view('frontend.pages.product', compact('categories', 'brands', 'products', 'productpage_banner_section'));
    }

    public function showProduct(string $slug)
    {
        $product = Product::withAvg('reviews', 'rating')->withCount('reviews')
